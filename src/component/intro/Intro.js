...
import mmyImg from '../../img/me1.png'
            ...
            <div className="i">
                <div className="i-left">
                    <div className="i-left-wrapper">
                        ...
                        <p className="i-desc">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos dolorem, facilis deleniti sint ad repellendus alias delectus ut optio repudiandae expedita veritatis enim unde quas, sit porro? Tempora, modi iste.
                        </p>
                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="i-scroll">
                ...
                <div className="i-right">
                    ...
                    <img src={mmyImg} alt="images" className="i-img" />
                </div>
            </div>
        </>
    )
